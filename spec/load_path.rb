...
raise RuntimeError.new 'File viper_bin_path.rb does not exist. Can be generated via: viper --bin-path-rb >./viper_bin_path.rb' unless File.exist?(File.expand_path(File.dirname(File.expand_path(__FILE__)) +  '/viper_bin_path.rb'))
